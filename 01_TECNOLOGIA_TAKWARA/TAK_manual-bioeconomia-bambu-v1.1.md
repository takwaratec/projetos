...
changelog:
  - version: "1.1"
    date: "2026-03-03"
    changes:
      - "Alinha a Fase 1 da cartilha ao Módulo Base (Camada 1) do Memorial Técnico da Biorrefinaria de Bambu (DOI 10.5281/zenodo.17225867): domos geodésicos como estufas de secagem + briquetes + bambu tratado sem veneno, antes da expansão química."
      - "Define Fase 2 como etapa de biorrefinaria e produtos avançados (biochar certificado, extrato pirolenhoso, compósitos Bambu+PU, E2G e metanol verde) apenas após estabilização do Módulo Base."
      - "Rebaixa o destaque da Junta SPIN para referência histórica e pioneira em conexões geodésicas de bambu no Brasil, enfatizando conexões Takwara como padrão atual pela rapidez de montagem e desmontagem."
      - "Refina a definição de Tecnologia Takwara como pacote ecológico completo (tratamento térmico, vapor com 20% de extrato pirolenhoso, PU vegetal e Solda Vegetal), reforçando a proibição de CCA/CCB/boro sem controle nos processos coletivos."
      - "Ajusta a governança faseada para refletir a separação entre Fase 0 (Domo Voador como dispositivo político-pedagógico) e Fase 1 (implantação da planta mínima de biorrefinaria e UBPs), em coerência com a Plataforma Amazônia Regenerativa v5.1."
---
keywords:
...
### Conexões históricas e o que a Plataforma usa hoje

Legado brasileiro: o Prof. Emérito José Luiz Mendes Ripper (1935–2025) e o Dr. Lucas Alves Ripper, do LILD/PUC-Rio, desenvolveram a **junta tipo SPIN (viga recíproca)**: em vez de conectores metálicos caros, a ponta de cada vara de bambu se apoia sobre a vara adjacente criando uma espiral, solidarizada com corda e torniquete de madeira. O custo das conexões cai ao valor da corda e a tecnologia foi pioneira no Brasil em domos geodésicos de bambu.

Na Plataforma Amazônia Regenerativa, porém, o padrão recomendado para implementação em cooperativas é o **sistema de conexões Takwara**: hubs de PU vegetal e Solda Vegetal que permitem montagem e desmontagem mais rápidas, maior repetibilidade dimensional e melhor integração ao tratamento ecológico (bambu tratado com vapor saturado enriquecido com extrato pirolenhoso). A Junta SPIN permanece como referência histórica e pedagógica; as conexões Takwara são o caminho indicado para quem quer montar, desmontar, transportar e replicar domos-estufa e abrigos emergenciais em poucos dias.
...
>
> 🟡 ***P. aurea***: vara útil máx. **3 m** (⌀ útil ≤ 4,5 cm) — cobre V1 e V3 5/8 até ⌀ 12m com folga.
> 🟢 ***P. edulis***: vara útil até **6 m+** (⌀ 6–10 cm) — cobre todos os tamanhos até V4 e além. Muito comum no território brasileiro.
...
- **1 único comprimento de vara** — todas as 25 varas são iguais. Você corta uma, corta todas. Zero erros de medição.
- **11 conectores** — apenas dois tipos: 5 de 4 vias (cintura) e 6 de 5 vias (topo e base)
- **Sem equador plano natural**: a forma cria uma base de 5 pontos de apoio no solo, naturalmente estável
...
>
> 🟡 ***Phyllostachys aurea* (bambu-dourado / cana-da-índia):**
> Colmo com 6–12 m de altura, mas **aproveitamento estrutural máximo de 3 m por vara** — só o trecho central tem diâmetro estável (≤ 4,5 cm) e sem conicidade extrema. Base e topo são descartados ou usados para biochar/briquetes.
> Um colmo médio de 9m rende **~2 varas aproveitáveis de 3m**.
> Para montar **uma tenda V1 de 26 m² (25 varas de 3m)**: você precisa de **~13 colmos** com boa seleção.
> ✅ **Espécie ideal para V1, V2 e V3 até ⌀ 12m** — as varas de até 2,47m necessárias cabem com sobra dentro do limite de 3m.
>
> 🟢 ***Phyllostachys edulis* (bambu-mossô):**
> Colmo de **6–10 cm de diâmetro** e até **12 m de comprimento** — vara estrutural útil de até 6m, com diâmetro uniforme muito maior.
> ✅ **Espécie ideal para V3 com ⌀ 14–15m e V4** — varas de 2,61 a 3,09m estão dentro do aproveitamento do P. edulis, com diâmetro e resistência superiores ao P. aurea.
...
```
Na Fase 1 da Plataforma, domos V2 como este são usados prioritariamente como **estufas de secagem Takwara**: estruturas de cobertura onde o bambu recém-colhido é empilhado e seco com ar quente limpo (60–80 °C), antes de entrar no tratamento térmico com vapor e no forno de pirólise do Módulo Base. Em termos simples: o domo V2 é a “estufa de secagem da cooperativa”, o primeiro degrau de infraestrutura para que briquetes, biochar e bambu tratado sem veneno possam existir com qualidade industrial.
...
### O Domo Voador como Fase 0 da Plataforma

O Domo Voador **não é um curso de bioconstrução** nem um canteiro-escola de 20 dias. Ele é um dispositivo político, pedagógico e afetivo: um domo geodésico leve e desmontável, transportável em van ou embarcação, erguível em poucas horas em praças, escolas ou espaços comunitários. Ele permanece 5 a 10 dias em cada localidade, tempo suficiente para sensibilizar, mapear demandas, identificar lideranças, realizar demonstrações práticas e, sobretudo, assinar cartas de intenção e acordos de cooperação com prefeituras, associações comunitárias, cooperativas e instituições de ensino.

Na lógica desta cartilha, o Domo Voador é **Fase 0**: prepara o terreno humano e institucional para que, quando a Fase 1 (Módulo Base da biorrefinaria + domos-estufa de secagem) for financiada, o território já tenha grupos organizados, cartas assinadas e gente formada no básico das tecnologias.
...
Quando não está em situação de emergência, o mesmo V3 5/8 funciona como **domo-estufa de produção**: na Fase 2 ele abriga linhas de compósitos Bambu+PU e prensas; na Fase 3, torna-se casca estrutural de habitações de interesse social em biocompósitos, sempre alimentadas por bambu previamente seco e tratado pelo Módulo Base.
...
**Vantagens para comunidades:**
- Custo da conexão = custo da corda (sisal ou náilon reciclado)
- Acomoda a conicidade e curvatura natural do bambu — sem a rigidez dos conectores metálicos que causam rachaduras
- Pode ser ensinada em 30 minutos, sem ferramentas elétricas
- Desmontável, reutilizável, transportável

> 📐 **Ferramenta de cálculo gratuita:** [geodesic-dome-calculator.com](https://geodesic-dome-calculator.com) — insira frequência, truncagem e diâmetro desejado; o site gera a lista completa de comprimentos de vara com os ângulos de dobra. Para geração de lista de corte completa com o coeficiente exato, use os valores desta seção multiplicados pelo raio (diâmetro ÷ 2).
...
Quando esta cartilha fala em “tratamento ecológico centralizado”, significa substituir totalmente esses preservantes tóxicos por rotas térmicas e biopoliméricas da Tecnologia Takwara: secagem em domos-estufa, tratamento com vapor enriquecido com extrato pirolenhoso e uso de polímeros vegetais nas conexões estruturais.
...
> 🔍 Por que isso importa para editais?
>
> Avaliações de Ciclo de Vida recentes mostraram que cadeias de bambu tratadas com boro e preservantes convencionais concentram mais de 90% do impacto em toxicidade humana justamente na gestão de efluentes e resíduos contaminados. Ao migrar para tratamento térmico + extrato pirolenhoso, a cooperativa reduz esse impacto e se alinha às salvaguardas ambientais exigidas por Fundo Amazônia, Fundo Clima e BNDES.
...
> Sempre que este Estatuto se referir a “bambu tratado”, o sentido é **bambu sem veneno**, tratado com o pacote tecnológico Takwara (tratamento térmico, vapor saturado com extrato pirolenhoso e proteção com polímero vegetal), conforme memorial técnico da Plataforma.
...
2. Tratamento térmico por vapor (câmara artesanal ou forno Takwara)
3. Fio de aço galvanizado para reforço interno (bitola 3mm)
...
| Fase | Período | Foco principal | Produto âncora | Governança |
| :-- | :-- | :-- | :-- | :-- |
| **Fase 0 — Domo Voador** | Pré-financiamento | Articulação territorial; assinatura de cartas de intenção; demonstração de tecnologias | Demonstração de domos, cabos e “bambu sem veneno” | Grupo informal + Carta de Intenção |
| **Fase 1 — Módulo Base (Camada 1)** | Meses 0–18 | **Planta mínima** de biorrefinaria: estufas geodésicas como estufas de secagem, UBPs, tratamento térmico + extrato pirolenhoso, briquetes e biochar básico | Bambu tratado sem veneno, briquetes, biochar, cabos de enxada | Associação registrada / cooperativa nascente |
| **Fase 2 — Linha de Produtos e Biorrefinaria Expandida (Camada 2)** | Meses 19–36 | Biorrefinaria de cascateamento térmico em regime **plug and play** (biochar certificado, extrato pirolenhoso, compósitos Bambu+PU, pilotos de E2G/metanol), domos-estufa permanentes | Biochar certificado (VM0044), extrato pirolenhoso, painéis e tijolos Bambu+PU, estufas, móveis | Cooperativa formalizada e/ou SPE comunitária com cooperativa como sócia |
| **Fase 3 — Escala, HIS e replicação** | Mês 37 em diante | HIS em escala, saneamento ecológico como mercado âncora, replicação em novos polos regionais, créditos de carbono, E2G/metanol como **upside** | Habitação social, contratos de saneamento ecológico, créditos de carbono, combustíveis híbridos | Rede de SPEs e holdings regionais, cooperativas de base articuladas |
...
> 🧭 **Regra de ouro para não errar as fases no edital**
>
> - **Fase 0:** Domo Voador (articulação territorial, cartas de intenção, demonstrações).
> - **Fase 1:** Módulo Base (biorrefinaria mínima + domos-estufa de secagem, UBPs, briquetes, biochar básico, bambu tratado sem veneno).
> - **Fase 2:** Biorrefinaria expandida e linha de produtos (biochar certificado, extrato pirolenhoso, compósitos Bambu+PU, pilotos de E2G/metanol).
> - **Fase 3:** HIS em escala, saneamento ecológico como mercado âncora, replicação em novos polos e créditos de carbono.
>
> Em qualquer edital, descreva domos-estufa de secagem + briquetes + biochar como **Fase 1** e deixe E2G/metanol como **Fase 2 em diante**.
...
Produto âncora: Cabo de enxada → domos-estufa de secagem (bambu tratado + briquetes + biochar básico) → Tiny Houses/HIS em compósitos.
...
- Acesso ao repositório técnico: [github.com/amazonia-regenerativa](https://github.com) (em implantação)
...
SILVA, J. et al. *Inventário de Biomassa de Bambu na Região Metropolitana de Campinas (RMC)*. Campinas: UNICAMP / Plataforma Amazônia Regenerativa, 2025. (Relatório técnico interno). Disponível em: repositório GitHub da Plataforma Amazônia Regenerativa.

TAKWARA, Fabio Resck. *Projeto Holambra Bambu: Hub Regional de Bioeconomia Circular e Inovação Tecnológica*. Holambra: Núcleo Takwara / Cooperativa Agropecuária Holambra, 2025. (Proposta técnica).

TAKWARA, Fabio Resck. *Plataforma Amazônia Regenerativa v5.1: Saneamento Ecológico, Bambu Guadua spp., PET Reciclado e Bioindústrias Comunitárias de Baixo Carbono*. Brasília: Núcleo Takwara / UnB, 2026. DOI: [10.5281/zenodo.18827106](https://doi.org/10.5281/zenodo.18827106).

TAKWARA, Fabio Resck. *Cooperativas de Manejo de Bambu: Modelos Jurídicos e Governança para a Bioeconomia Comunitária*. Brasília: Núcleo Takwara / UnB, 2025. (Documento técnico de apoio).

TAKWARA, Fabio Resck. *Estufas Geodésicas e Estruturas Emergenciais em Bambu: Sólidos Platônicos Aplicados à Bioeconomia*. Brasília: Núcleo Takwara / UnB, 2025. (Documento técnico de apoio).
