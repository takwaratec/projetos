...
A presente disposição introduzida em **Equipamento de Processamento de Materiais Lignocelulósicos** refere-se a um aperfeiçoamento em tamboreadores rotativos, especificamente um modelo de reuso industrial destinado ao lixamento facilitado por calor (Abrasão Térmica) de varas de bambu.

### 1.2 Problema Técnico e Estado da Arte
Equipamentos convencionais de lixamento mecânico operam a frio, exigindo alta potência de motorização e gerando desgaste prematuro de lixas e abrasivos sintéticos. O protótipo original IFB/UnB resolve este impasse utilizando **areia quente** como mídia abrasiva e vetor térmico, amolecendo os polímeros naturais da epiderme do bambu antes da ação de fricção.
...
2.  **Base Térmica:** Estrutura de alvenaria ou terra comprimida contendo um fogão foguete (Rocket Stove) acoplado longitudinalmente sob o tambor.
...
**APA:**
Takwara, F. R. (2026). *Memorial Jurídico: Tamboreador Comunitário IFB/UnB (Mídia Granular Aquecida)* (Versão 5.1). Memorial de Patente — Núcleo Takwara / Universidade de Brasília / IFB. https://doi.org/10.5281/zenodo.18827106
