...
**Versão:** 2.0 | **Data:** 04 de março de 2026
...
Substitua `18827106` pelo número do seu DOI. Isso gera um **badge clicável** na capa do repositório — um sinal visual de que o projeto é citável e verificável.
