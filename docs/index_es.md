...
Bienvenido(a) a la documentación oficial de la Plataforma Amazonía Regenerativa. Este espacio consolida el capital intelectual, técnico y estratégico del proyecto, sirviendo como hub central para evaluadores, auditores y asociados.

## 📂 Ejes de Evaluación

Navegue por la estructura completa de la Plataforma a través de los ejes a continuación:

### 1. Estrategia y Gobernanza
Documentos que validan la integridad, autoría y sostenibilidad administrativa del proyecto.
- [Resumen Ejecutivo (v2.1)](01_TECNOLOGIA_TAKWARA/TAK_relatorio-executivo-v1.0.1_es.md)
- [Derechos de Autoría y PI](00_GOVERNANCA/GOV_AUTORIA_es.md)
- [Matriz de Correlación de Proyectos](00_GOVERNANCA/GOV_MATRIZ_CORRELACAO_es.md)
- [Política de Compartición de Datos](00_GOVERNANCA/GOV_nota-tecnica-compartilhamento-de-dados_es.md)
- [Memorando de Presupuesto](00_GOVERNANCA/GOV_memorando-orcamento-consolidado_es.md)
...
Este acervo sigue el **Protocolo 5.1** y el estándar **BTC v2.1**, con versionamiento auditable vía Git y preservação histórica vía Zenodo.
