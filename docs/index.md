...
Navegue pela estrutura completa da Plataforma através dos eixos abaixo:
...
- [Direitos de Autoria e PI](00_GOVERNANCA/GOV_AUTORIA.md)
- [Matriz de Correlação de Projetos](00_GOVERNANCA/GOV_MATRIZ_CORRELACAO.md)
...
Perfis técnicos e científicos liderando as frentes da Plataforma.
- [Fabio Resck Takwara (Tecnologia)](06_ANAIS_MEMORIA/perfis-equipe/OPS_perfil-fabio-takwara.md)
- [Profa. Tânia Cruz (Pesquisa Científica)](06_ANAIS_MEMORIA/perfis-equipe/OPS_perfil-taina-cruz.md)
- [Jesiel Campos (Engenharia e Campo)](06_ANAIS_MEMORIA/perfis-equipe/OPS_perfil-jesiel-campos.md)
- [Tiago Filemon (Gestão Estratégica)](06_ANAIS_MEMORIA/perfis-equipe/OPS_perfil-tiago-filemon.md)
...
Este acervo segue o **Protocolo 5.1** e o padrão **BTC v2.1**, com versionamento auditável via Git e preservação histórica via Zenodo.
