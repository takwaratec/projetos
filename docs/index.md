...
A **Plataforma Amazônia Regenerativa** não é apenas um repositório de documentação técnica, mas um **sistema dinâmico de auditoria, transparência e governança (Protocolo 5.1)**. Este ecossistema foi desenhado para servir de balizamento analítico e crivo de impacto para projetos socioambientais de alta complexidade no Brasil.

Através de uma arquitetura de dados aberta e rastreável (Master DOI), a Plataforma oferece a auditores, avaliadores e doadores uma visão granular dos fluxos financeiros, nexos causais e salvaguardas reais aplicadas no território. Aqui, a tecnologia atua como camada de verificação independente, eliminando assimetrias de informação e garantindo que cada investimento se converta em bio-soberania comunitária efetiva.

---

## 🎯 Dossiê de Avaliação (Fundo Amazônia)

Para fins de crivo analítico imediato, consulte os documentos finais auditados e prontos para submissão:

*   📑 [**01. Formulário Consolidado**](09_DOSSIE_BNDES/01_FORMULARIO_01_CONSOLIDADO.md) — *Detalhamento Técnico (Mestre 5.1)*
*   📊 [**02. Orçamento Consolidado**](09_DOSSIE_BNDES/02_FORMULARIO_ORCAMENTO_CONSOLIDADO.md) — *Rubricas por categoria BNDES*
*   🗺️ [**03. Mapa de Migração**](09_DOSSIE_BNDES/03_MAPA_MIGRACAO_BNDES_C02.md) — *Guia de transposição sistêmica*
*   🛡️ [**04. Relatório de Auditoria 5.1**](09_DOSSIE_BNDES/06_RELATORIO_AUDITORIA_5.1.md) — *Parecer de integridade e salvaguardas*
...
*   💰 [Consolidação Orçamentária (v2.2)](09_DOSSIE_BNDES/05_RESUMO_CONSOLIDACAO_ORCAMENTARIA.md)
...
Este acervo segue o **Protocolo 5.1**, com versionamento auditável via Git e preservação histórica via Zenodo sob o padrão de integridade da Plataforma Amazônia Regenerativa.
